...
namespace Microsoft.Azure.CognitiveServices.Vision.Face
{
    ...
    public static partial class LargePersonGroupOperationsExtensions
    {
            ...
            /// </param>
            public static async Task CreateAsync(this ILargePersonGroupOperations operations, string largePersonGroupId, string name = default(string), string userData = default(string), RecognitionModel recognitionModel = default(RecognitionModel), CancellationToken cancellationToken = default(CancellationToken))
            {
