...
namespace Microsoft.Azure.CognitiveServices.Vision.Face
{
    ...
    public static partial class LargeFaceListOperationsExtensions
    {
            ...
            /// </param>
            public static async Task CreateAsync(this ILargeFaceListOperations operations, string largeFaceListId, string name = default(string), string userData = default(string), RecognitionModel recognitionModel = default(RecognitionModel), CancellationToken cancellationToken = default(CancellationToken))
            {
