...
namespace Microsoft.Azure.CognitiveServices.Vision.Face.Models
{
    ...
    public partial class LargeFaceList : MetaDataContract
    {
        ...
        public LargeFaceList(string largeFaceListId, string name = default(string), string userData = default(string), RecognitionModel recognitionModel = default(RecognitionModel))
